 ...
 * under the License.
 */
package preformance_test.handler;

import preformance_test.test.TestCenter;
...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private void handleWebSocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        if (frame instanceof TextWebSocketFrame) {
            ...
            //发送到客户端websocket
            ctx.channel().write(new TextWebSocketFrame(((TextWebSocketFrame) frame).text()+ ", 欢迎使用Netty WebSocket服务， 现在时刻:"+ new java.util.Date().toString()));
